        ...
        <div className="p-2 bg-white rounded-xl shadow-md overflow-hidden flex flex-col mx-5 md:mx-10 ">
          ...
          <div className="max-w-6xl mx-auto p-6 space-y-6">
            ...
            <div className="flex md:justify-between flex-col md:flex-row md:items-center ">
              ...
              <h3 className="text-xl font-semibold pt-5 md:p-0 ">
                الأعذار المقدمة
              </h3>
            </div>
            {/* التقرير */}
            ...
            <div className="sm:hidden space-y-4">
              {excuses.length === 0 ? (
                ...
                excuses.map((excuse) => (
                  ...
                  >
                    <p>
                      <strong>رقم:</strong> {excuse.id}
                    </p>
                    <p>
                      <strong>التاريخ:</strong> {excuse.date}
                    </p>
                    <p>
